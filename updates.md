...
📝Shows information on the latest updates and into the specifics of what we did to better the experience!<br>
...
- Fixed the `/diff` command to actually show the difference between the two strings
## Update: Beta 1.4
